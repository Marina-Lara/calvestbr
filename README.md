...
Mover o arquivo CSV 'ranking_universidades' localizado no repositório 'calvestbr' para a pasta que irá rodar o código (https://github.com/Marina-Lara/calvestbr/blob/main/ranking_universidades.csv)<br />
